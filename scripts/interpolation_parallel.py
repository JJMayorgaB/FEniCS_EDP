...
def main():
    ...
    if rank == 0:
        ...
        os.makedirs("figures/interpolation", exist_ok=True)
        os.makedirs("post_data/interpolation", exist_ok=True)
    ...
    try:
        ...
        filename = f"post_data/interpolation/output_nedelec_parallel"
    ...
    try:
        ...
        if rank == 0:
            ...
            plotter.view_xy()
            plotter.screenshot(f"figures/interpolation/process0_magnitude_{size}procs.png")
            plotter.close()  # Cerrar plotter explícitamente
            print(f"Process 0 visualization saved: figures/interpolation/process0_magnitude_{size}procs.png")
        ...
        try:
            ...
            if rank == 0:
                ...
                if len(local_grids) > 1:
                    ...
                    # Save main image
                    pl.screenshot(f"figures/interpolation/uh_interpolation_parallel_{size}procs_4plots.png")
                    pl.close()  # Cerrar plotter explícitamente
                    print(f"Global visualization saved: figures/interpolation/uh_interpolation_parallel_{size}procs_4plots.png")
                    ...
                    plotter_simple.screenshot(f"figures/interpolation/uh_magnitude_parallel_{size}procs.png")
                    plotter_simple.close()  # Cerrar plotter explícitamente
                    print(f"Simple magnitude visualization saved: figures/interpolation/uh_magnitude_parallel_{size}procs.png")
                    ...
                    pl.screenshot(f"figures/interpolation/uh_interpolation_parallel_{size}procs_4plots.png")
                    pl.close()  # Cerrar plotter explícitamente
                    print(f"Single process visualization saved: figures/interpolation/uh_interpolation_parallel_{size}procs_4plots.png")
